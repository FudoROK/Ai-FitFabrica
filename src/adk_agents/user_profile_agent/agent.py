"""FitFabrica user profile ADK agent assembly."""
...
from .prompt_config import USER_PROFILE_DESCRIPTION, USER_PROFILE_INSTRUCTION
...
_root_llm_agent = llm_agent.LlmAgent(
    ...
    output_schema=UserProfileContract,
