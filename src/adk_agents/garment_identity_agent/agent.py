"""FitFabrica garment identity ADK agent assembly."""
...
from .prompt_config import GARMENT_IDENTITY_DESCRIPTION, GARMENT_IDENTITY_INSTRUCTION
...
_root_llm_agent = llm_agent.LlmAgent(
    name="Garment_Identity_Agent",
    model="gemini-2.5-flash",
    output_schema=GarmentIdentityContract,
    description=GARMENT_IDENTITY_DESCRIPTION,
    sub_agents=[],
    instruction=GARMENT_IDENTITY_INSTRUCTION,
    tools=[],
)
