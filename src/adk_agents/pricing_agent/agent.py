"""FitFabrica pricing ADK agent assembly."""
...
from .contracts import PricingRecommendationContract
from .prompt_config import PRICING_AGENT_DESCRIPTION, PRICING_AGENT_INSTRUCTION
...
_root_llm_agent = llm_agent.LlmAgent(
    ...
    output_schema=PricingRecommendationContract,
    description=PRICING_AGENT_DESCRIPTION,
    sub_agents=[],
    instruction=PRICING_AGENT_INSTRUCTION,
    tools=[],
)
