"""FitFabrica fashion stylist ADK agent assembly."""
...
from .prompt_config import FASHION_STYLIST_DESCRIPTION, FASHION_STYLIST_INSTRUCTION
...
_root_llm_agent = llm_agent.LlmAgent(
    name="Fashion_Stylist_Agent",
    model="gemini-2.5-flash",
    output_schema=FashionStylistNoteContract,
    description=FASHION_STYLIST_DESCRIPTION,
    sub_agents=[],
    instruction=FASHION_STYLIST_INSTRUCTION,
    tools=[],
)
