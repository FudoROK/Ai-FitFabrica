"""FitFabrica marketplace ADK agent assembly."""
...
from .contracts import MarketplaceSearchStrategyContract
from .prompt_config import MARKETPLACE_AGENT_DESCRIPTION, MARKETPLACE_AGENT_INSTRUCTION
...
_root_llm_agent = llm_agent.LlmAgent(
    ...
    output_schema=MarketplaceSearchStrategyContract,
    description=MARKETPLACE_AGENT_DESCRIPTION,
    sub_agents=[],
    instruction=MARKETPLACE_AGENT_INSTRUCTION,
    tools=[],
)
