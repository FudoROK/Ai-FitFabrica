"""Daily memory ADK agent assembly."""
...
from .prompt_config import DAILY_MEMORY_INSTRUCTION, DAILY_MEMORY_DESCRIPTION
...
_root_llm_agent = llm_agent.LlmAgent(
    name="Daily_Memory_Agent",
    model="gemini-2.5-flash",
    output_schema=DailyMemoryContract,
    description=DAILY_MEMORY_DESCRIPTION,
    sub_agents=[],
    instruction=DAILY_MEMORY_INSTRUCTION,
    tools=[],
)
