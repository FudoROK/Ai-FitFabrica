...
REQUIRED_ARTIFACTS = {
    ...
    "post_billing_live_acceptance_template": "docs/reports/templates/post_billing_live_acceptance_template.md",
    "auth_readiness_gate": "scripts/auth_readiness_gate.py",
    "auth_readiness_runbook": "docs/runbooks/auth_readiness_gate.md",
    "billing_readiness_gate": "scripts/billing_readiness_gate.py",
    "billing_readiness_runbook": "docs/runbooks/billing_readiness_gate.md",
    "production_infrastructure_readiness_gate": "scripts/production_infrastructure_readiness_gate.py",
    "production_infrastructure_readiness_runbook": "docs/runbooks/production_infrastructure_readiness_gate.md",
    "post_billing_staging_env_template": ".env.post-billing-staging.example",
    "post_billing_staging_env_runbook": "docs/runbooks/post_billing_staging_env.md",
    "production_fallback_usage_audit": "scripts/production_fallback_usage_audit.py",
    "production_fallback_usage_runbook": "docs/runbooks/production_fallback_usage_audit.md",
    "web_dependency_audit": "scripts/web_dependency_audit.py",
    "web_dependency_audit_runbook": "docs/runbooks/web_dependency_audit.md",
...
def run_gate(*, api_base_url: str | None, status_token: str | None) -> dict[str, object]:
    ...
    return {
        ...
        "next_commands": [
            "python scripts/production_infrastructure_readiness_gate.py --env-file .env.post-billing-staging.local --require-production",
            "python scripts/platform_foundation_smoke.py --require-ready",
            "python scripts/auth_readiness_gate.py",
            "python scripts/billing_readiness_gate.py",
            "python scripts/production_infrastructure_readiness_gate.py --require-production",
            "python scripts/production_fallback_usage_audit.py --require-ready",
            "python scripts/web_dependency_audit.py --require-ready",
