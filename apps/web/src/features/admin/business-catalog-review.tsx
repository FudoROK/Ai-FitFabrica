...
type DiscoveryCandidateFilters = {
  category: string;
  city: string;
...
function DiscoveryCandidateReviewPanel({
  candidates,
  filters,
  onArchive,
  onApprove,
  ...
  onFiltersChange: (filters: DiscoveryCandidateFilters) => void;
      ...
      <label className="grid gap-2 text-sm font-semibold text-[var(--text-primary)]">
        ...
        <select
          ...
          onChange={(event) =>
            onFiltersChange({
              ...filters,
              status: event.target.value as DiscoveryCandidateFilters["status"],
            })
          }
      ...
      <label className="grid gap-2 text-sm font-semibold text-[var(--text-primary)]">
        ...
        <select
          ...
          onChange={(event) =>
            onFiltersChange({
              ...filters,
              sourceType: event.target.value as DiscoveryCandidateFilters["sourceType"],
            })
          }
